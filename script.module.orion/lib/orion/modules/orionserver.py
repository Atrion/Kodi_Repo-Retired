...
class OrionServer:
	...
	def dialog(self):
		...
		color = None
		status = self.status()
		if status == self.StatusDown: color = OrionInterface.ColorBad
		elif status == self.StatusMaintenance: color = OrionInterface.ColorPoor
		elif status == self.StatusUsage: color = OrionInterface.ColorMedium
		elif status == self.StatusOperational: color = OrionInterface.ColorGood
