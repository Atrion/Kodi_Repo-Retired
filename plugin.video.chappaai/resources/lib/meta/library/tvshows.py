...
def add_tvshow_to_library(library_folder, show, play_plugin = None):
    ...
    if not xbmcvfs.exists(playlist_folder):
        ...
        except: dialogs.notify(msg=_('Creation of Chappaai Playlist Folder'), title=_('Failed'), delay=5000, image=get_icon_path("lists"))
...
def setup_library(library_folder):
    ...
    if not xbmcvfs.exists(library_folder):
        ...
        msg = _("Would you like to automatically set Chappaai as a tv shows source?")
