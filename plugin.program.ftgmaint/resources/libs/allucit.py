...
ALLUCID = {
	...
	'zen': {
		'name'     : 'Zen',
		'plugin'   : 'plugin.video.zen',
		'saved'    : 'alluczen',
		'path'     : os.path.join(ADDONS, 'plugin.video.zen'),
		'icon'     : os.path.join(ADDONS, 'plugin.video.zen', 'icon.png'),
		'fanart'   : os.path.join(ADDONS, 'plugin.video.zen', 'fanart.jpg'),
		'file'     : os.path.join(ALLUCFOLD, 'zen_alluc'),
		'settings' : os.path.join(ADDOND, 'plugin.video.zen', 'settings.xml'),
		'default'  : 'alluc_username',
		'data'     : ['enable_alluc', 'alluc_username', 'alluc_password', 'alluc_debrid', 'alluc_max_results'],
		'activate' : ''},
	'specto': {
		'name'     : 'Specto',
	...
	'salts': {
		...
		'file'     : os.path.join(ALLUCFOLD, 'salts_alluc'),
