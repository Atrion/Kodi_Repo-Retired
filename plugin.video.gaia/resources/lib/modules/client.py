...
def request(url, close=True, redirect=True, error=False, proxy=None, post=None, headers=None, mobile=False, XHR=False, limit=None, referer=None, cookie=None, compression=True, output='', timeout='30', ignoreSsl = False, flare = True):
	try:
		# Gaia
			...
			if response.code == 503:
				...
				if flare and 'cloudflare' in str(response.info()).lower():
					try:
						...
						response = orionoid.Orionoid().flare(link = url)
