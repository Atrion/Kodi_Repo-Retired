        ...
        try:
            ...
            try:
                ...
                for url in gvideos:
                    ...
                    sources.append({'source': 'gvideo', 'quality': gtag['quality'], 'language': 'en', 'url': gtag['url'], 'direct': True, 'debridonly': False, 'external' : True})
            except:
                pass
            ...
            try:
                ...
                for url in oloads:
                    sources.append({'source': 'CDN', 'quality': 'HD', 'language': 'en', 'url': url, 'direct': False, 'debridonly': False, 'external' : True})
            except:
                pass
