		...
		try:
			...
			while True:
				...
				for i in range(1, len(htmlRows)): # First row is header.
					...
					# Metadata
					meta = metadata.Metadata(name = htmlName, title = title, year = year, season = season, episode = episode, pack = pack, packCount = packCount, link = htmlLink, size = htmlSize, seeds = htmlSeeds, languageAudio = htmlLanguages)
