...
class source:
	...
	def __init__(self):
		...
		self.priority = 0
		self.language = ['un']
		self.domains = ['limetorrents.io', 'limetorrents.cc', 'limetorrents.unblockall.xyz', 'limetorrents.bypassed.cool', 'limetorrents.unblocked.world', 'limetorrents.unblocked.today']
		self.base_link = 'https://www.limetorrents.io'
